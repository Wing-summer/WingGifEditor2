...
&emsp;&emsp;相对于老版本的`WingGifEditor`，它修复了一些 Bug，具有更现代的用户界面，更快的 Gif 图像加载速度和保存速度以及相对较低的内存占用，更好的图像编辑体验，以提供简单易用满足基本需求的 GIF 编辑器。
...
7. 不得在安装程序内插入任何含有商业推广的内容，并且严格遵守第二条内容。
