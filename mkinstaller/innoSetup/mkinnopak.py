...
def main():
    parser = argparse.ArgumentParser(
        prog="mkinnopak.py", description="A InnoSetup installer maker for WingGifEditor2")
    ...
    version_file_src = os.path.join(projectdeb, "WINGGIF_VERSION")
    ...
    if (os.path.exists(os.path.join(projectdeb, "WingGifEditor2.sln"))):
    ...
    if (os.path.exists(exemain_src) == False):
        print(
            Fore.RED + "[Error] WingGifEditor2.exe is not found!" + Style.RESET_ALL)
        exit(-3)
...
#define MyAppURL "https://github.com/Wing-summer/WingGifEditor2"
...
AppId={{EEF94B1C-E1A9-491B-B67C-08957B838482}
AppName={#MyAppName}
